...
<div class="all">
            ...
            <div class="syn">
            	...
            	<?php 
	                if ($this->basic->countstr($topic['title'])>36)
	             	...
	             	$topic['or_description']=strip_tags($topic['description']);
	             	$topic['or_comments']=strip_tags($topic['comments']);
    ...
    <div class="content_con">
    	<div class="top">
        	<div class="ls">
            	<div class="word" style="cursor: pointer;">话题背景</div>
            </div>
            <div class="title">
            	<div class="left"></div>
                <div class="title">
                	<?php 
	                	if ($this->basic->countstr($topic['title'])>70)
	             		{
	             			$topic['ll_title']=$this->basic->utfSubstr($topic['title'],0,70);
	             		}else {
	             			$topic['ll_title']=$topic['title'];
	             		}
             		?>
                	<div class="date"><?php echo @date("Y年m月d日",strtotime($topic['post_time']));?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo @"作者：".$topic['author']."&nbsp;&nbsp;&nbsp;&nbsp;浏览量：".$topic['count'];?></div>
                    <div class="word"><a href="<?php echo @site_url('info/'.$topic['id']);?>"><?php echo @$topic['ll_title'];?></a></div>
                </div>
            </div>
        </div>
        <div class="mid">
      			 <div class="news_content" >
            		<P style="text-indent:2em;"><span style="font-size:18px;color:#000;">话题背景：</span><?php echo @$topic['or_description'];?></P>
            		<P style="text-indent:2em;"><span style="font-size:18px;color:#000;">编者按：</span><?php echo @$topic['or_comments'];?></P>
            	</div>
