    ...
    <div id="navi">	    
        <div id="nav">
          <ul>
            ...
            <li  class="nav_li_hover"><a href="<?php echo site_url('feedback');?>">意见反馈</a></li>
          </ul>
        </div>
    </div>
    </div>
      ...
      <div id="main">
        <div id="main_top" style="height:auto;float:left;">
          <div id="title_bar">
            <div id="latest_topic">
              <div id="square"></div>
              <a   href="<?php echo site_url('feedback');?>" class="latest_topic_link">意见反馈</a>
            </div>
          </div>
          
             
             <div class="content" style="height:auto;float:left;">
             	<p style="text-align:left;margin:20px 0;">如果您对我们的《每周话题》栏目有意见或者建议，您可以在此留言。</p>
