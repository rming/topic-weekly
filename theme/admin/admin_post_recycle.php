...
<title>文章回收站——青春在线网站每周话题栏目</title>
    	...
    	<div class="content_con">
    			...
    			<div class="right">
    				<div class="right_title">
    					<div class="cateselect">
	    					...
	    					<option value="<?php echo site_url('admin/post/recycle')?>" selected="selected">-是否清空-</option>
	    					<option value="<?php echo site_url('admin/post/recycle')."?clean=1"?>" >&nbsp;全部清空</option>
	    					</select>
    					</div>
    				</div>
    		...
    		<div class="left">
    			<ul>
    				...
    				<li><a href="<?php echo site_url('admin/post/recycle'); ?>" class='nav_hover' >文章回收站</a></li>
    				<li style="height:0px;"></li>
