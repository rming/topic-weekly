...
<title>话题回收站——青春在线网站每周话题栏目</title>
    	...
    	<div class="content_con">
    			...
    			<div class="right">
    				<div class="right_title">
    					<div class="cateselect">
	    					...
	    					<option value="<?php echo site_url('admin/topic/recycle')?>" selected="selected">-是否清空-</option>
	    					<option value="<?php echo site_url('admin/topic/recycle')."?clean=1"?>" >&nbsp;全部清空</option>
	    					</select>
    					</div>
    				</div>
    		...
    		<div class="left">
    			<ul>
    				...
    				<li><a href="<?php echo site_url('admin/topic/recycle'); ?>"   class='nav_hover'>话题回收站</a></li>
