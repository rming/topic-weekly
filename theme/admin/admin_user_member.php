    			...
    			<div class="right">
    				<div class="right_title">
    					<div class="cateselect">
	    					...
	    					<option value="<?php echo site_url('admin/user');?>">-用户分类-</option>
	    					<option value="<?php echo site_url('admin/user/member')."?status=2"?>"  <?php if (isset($_GET['status'])){if ($_GET['status']=='2'){?> selected="selected"<?php }}?>>&nbsp;管理员</option>
	    					<option value="<?php echo site_url('admin/user/member')."?status=1"?>"   <?php if (isset($_GET['status'])){if ($_GET['status']=='1'){?> selected="selected"<?php }}?>>&nbsp;普通会员</option>
	    					<option value="<?php echo site_url('admin/user/member')."?all=1"?>" <?php if (isset($_GET['all'])){if ($_GET['all']=='1'){?> selected="selected"<?php }}?> >&nbsp;全部会员</option>
