    			...
    			<div class="right">
    				...
    				<div class="right_content" >
						...
						<div class="post_form" style="height:auto;">
							...
							<li><span class="post_t">编辑昵称：</span><span class="post_c"><?php echo form_input('editname',set_value('editname')); ?><?php echo form_error('editname');?><font size="-1" color="red">(*)</font></span></li>
							<li><span class="post_t">真实姓名：</span><span class="post_c"><?php echo form_input('realname',set_value('realname')); ?><?php echo form_error('realname');?><font size="-1" color="red">(*)</font></span></li>
							...
							<li><span class="post_t">密码：</span><span class="post_c"><?php echo form_password('password',set_value('password')); ?><?php echo form_error('password');?><font size="-1" color="red">(*)</font></span></li>
