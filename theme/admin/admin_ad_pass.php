    	...
    	<div class="content_con">
    				...
    				<div class="right_content">
    					<table width="600" border="0" >
						  <tr style="background:#eee;">
						    <th width="254" scope="col">广告图片</th>
						    <th width="200" scope="col">链接地址</th>
						    <th width="50" scope="col">点击</th>
						    <th width="60" scope="col">作者</th>
    		...
    		<div class="left">
    			<ul>
    				...
    				<li><a href="<?php echo site_url('admin/ad/pass');?>"  class='nav_hover' >广告管理</a></li>
    			</ul>
    		</div>
        </div>
    </div>
