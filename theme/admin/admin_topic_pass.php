    	...
    	<div class="content_con">
    			...
    			<div class="right">
    				<div class="right_title">
    					<div class="cateselect">
	    					...
	    					<option value="<?php echo site_url('admin/topic/pass')?>" <?php if (!isset($_GET['order'])){?>selected="selected"<?php }?>>--排序规则--</option>
	    					<option value="<?php echo site_url('admin/topic/pass')."?order=1"?>" <?php if (isset($_GET['order'])){if ($_GET['order']=='1'){?>selected="selected"<?php }}?>>&nbsp;&nbsp;时间顺序</option>
	    					<option value="<?php echo site_url('admin/topic/pass')."?order=2"?>" <?php if (isset($_GET['order'])){if ($_GET['order']=='2'){?>selected="selected"<?php }}?>>&nbsp;点击量顺序</option>
	    					</select>
    					</div>
    				</div>
    		...
    		<div class="left">
    			<ul>
    				...
    				<li><a href="<?php echo site_url('admin/topic/pass'); ?>"   class='nav_hover'>话题管理</a></li>
