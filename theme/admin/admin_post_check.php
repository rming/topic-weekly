    	...
    	<div class="content_con">
    			...
    			<div class="right">
    				<div class="right_title">
    					<div class="cateselect">
	    					...
	    					<option value="<?php echo  site_url('admin/post/check');?>">——————————话题选择——————————</option>
	    					<?php 
	    						foreach ($topics as $row)
									{
										echo "<option value=\"".site_url('admin/post/check')."?tid=".($row['id'])."\"";
										if (isset($_GET['tid'])){
											if ($_GET['tid']==$row['id']){
    		...
    		<div class="left">
    			<ul>
    				...
    				<li><a href="<?php echo site_url('admin/post/check'); ?>" class='nav_hover'>文章审核</a></li>
